    ...
    render() {
        return (
            <View style={{flex: 1, marginTop: Platform.OS === 'ios' ? 34 : 0}}>
                <Text style={{margin: 10, fontWeight: 'bold', color: 'forestgreen', fontSize: 20}}>REDUX SAGA WITH TN98  </Text>
                <Text style={{margin: 10, color: 'balck', fontSize: 20}}>NEW MOVIE INFORMATION</Text>
